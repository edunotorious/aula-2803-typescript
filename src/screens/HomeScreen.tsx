...
import { FlatList, FlatListProps, RefreshControl, TouchableOpacity } from 'react-native';
...
const AppointmentList = styled(FlatList<Appointment>).attrs({
  ...
  return (
    <Container>
      ...
      <Content>
        ...
        <AppointmentList
          data={appointments} // Tipagem de appointments já é Appointment[]
          keyExtractor={(item: Appointment) => item.id}
          renderItem={({ item }: { item: Appointment }) => renderAppointment({ item })}
